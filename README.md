...
| **Tested On** | Brave/Vivaldi(PC) with uBlock Origin/uBlock Origin Lite Extension|
| **Creator** | Rekoy |
...
1.  Open the `Anti-YouTube Shorts.txt` file and **copy all** the text inside.
2.  Open your uBlock Origin or uBlock Origin Lite dashboard and go to the **"My Filters"** tab.
3.  Paste the copied text into the large filter box.
4.  Click **"Apply changes."**
5.  Refresh your YouTube web page or Hard Refresh your Browser (Ctrl + Shift + R)
6.  Enjoyyyy!
...
1.  Find the **Raw URL** for the `Anti-YouTube Shorts.txt` file on GitHub and **copy the URL**.
2.  Open your uBlock Origin dashboard and go to the **"Filter lists"** tab.
3.  Scroll to the very bottom and check the box next to **"Import..."**
4.  Paste the Raw URL into the box that appears.
5.  Click **"Apply changes."** uBlock will now handle updates for you!

---

## ⚠️ Known Issues & Community Help

**Disclaimer:** I am not a professional developer, and this script is a free time hobby project and community effort. YouTube updates frequently, which may cause this script to misbehave or stop working entirely.
I do not take any responsibility for the use of this script. Use at your own risk.
...
* Johan Bleuzen ([www.johanbleuzen.fr](https://www.johanbleuzen.fr))
* Gijs (GitHub: [gijsdev/ublock-hide-yt-shorts](https://github.com/gijsdev/ublock-hide-yt-shorts))
* Brave’s official `yt anti-shorts` block list (GitHub: [brave/adblock-lists](https://github.com/brave/adblock-lists))
* The kind and helpful people on r/uBlockOrigin (Reddit) and other online forums and communities and many more!.
